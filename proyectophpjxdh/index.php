...
include 'BasedatoJXDH/bdjxdh.php';

header('Access-Control-Allow-Origin: *');//resivir peticiones
...
if($_POST['METHOD']=='PUT'){
    ...
    $telefono_usuario=$_POST['telefono_usuario'];
    $mail_usuario=$_POST['mail_usuario'];
    $query="UPDATE tbl_usuario SET nombre_usuario='$nombre_usuario', cedula_usuario='$cedula_usuario', telefono_usuario='$telefono_usuario', mail_usuario='$mail_usuario' WHERE tbl_usuario.id_usuario='$id_usuario'";
